# Telegram comes from the rolling Void repository, which does not hold the same
...
amd64="$(xbps_package telegram-desktop x86_64)"
arm64="$(xbps_package telegram-desktop aarch64)"
