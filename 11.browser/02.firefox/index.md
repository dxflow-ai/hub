...
```bash
dxflow workflow create --identity firefox firefox.yml
...
Open your browser at `http://localhost:6082/vnc.html` and enter the password you set in `VNC_PASSWORD`. Firefox is already running and maximized. Port `5901` is also exposed for connecting a native VNC client.
