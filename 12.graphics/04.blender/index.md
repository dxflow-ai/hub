...
- Rendering runs on the CPU here: the software OpenGL the desktop provides drives the viewport, and Cycles has no card to offload to. Give the step more `cpu` for heavier scenes.
