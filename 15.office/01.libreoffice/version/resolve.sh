# LibreOffice comes from the rolling Void repository, which does not hold the same
...
amd64="$(xbps_package libreoffice x86_64)"
arm64="$(xbps_package libreoffice aarch64)"
