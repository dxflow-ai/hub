...
const styles = tv({
    extend: focusRing,
    base: "flex items-center select-none text-start gap-4 w-full cursor-pointer border border-black/20 dark:border-white/20 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-none rounded-lg pl-3 pr-2 py-2 min-w-[150px] bg-gray-50 dark:bg-zinc-700",
    variants: {
        isDisabled: {
            ...
            true: "text-gray-200 dark:text-zinc-600 forced-colors:text-[GrayText] dark:bg-zinc-800 dark:border-white/5 forced-colors:border-[GrayText] cursor-default",
        },
    },
});
    ...
    return (
        ...
        >
            ...
            <Button className={styles}>
                <SelectValue className="flex-1 overflow-hidden overflow-ellipsis whitespace-nowrap text-sm placeholder-shown:italic" />
                <ChevronDown
                    aria-hidden
            ...
            <Popover className="min-w-[--trigger-width] border border-black/20 dark:border-white/20">
                ...
                {extra && <div slot="extra">{extra}</div>}
            </Popover>
        </AriaSelect>
    );
}
