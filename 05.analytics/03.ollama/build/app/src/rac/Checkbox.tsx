...
const boxStyles = tv({
    extend: focusRing,
    base: "w-4 h-4 flex-shrink-0 rounded flex items-center justify-center border-2",
    variants: {
        isSelected: {
            false: "bg-white/25 dark:bg-black/45 border-[--color] [--color:theme(colors.gray.400)] dark:[--color:colors.zinc.400)] group-pressed:[--color:theme(colors.gray.500)] dark:group-pressed:[--color:theme(colors.zinc.300)]",
